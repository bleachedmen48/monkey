...
if
 ...
 then
    writefile("Moonware//" .. Name, game:service "HttpService":JSONEncode(Des))
end

Settings = game:service "HttpService":JSONDecode(readfile("Moonware//" .. Name))

local function Save()
    writefile("Moonware//" .. Name, game:service "HttpService":JSONEncode(Settings))
end
...
local Library = loadstring(game:HttpGet("https://pastebin.com/raw/q1pVUyf9"))()
